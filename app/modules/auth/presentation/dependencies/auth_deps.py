...
# ============================================================
# SECURITY SCHEME (🔥 ISSO ativa o cadeado no Swagger)
# ============================================================
...
def get_forgot_password_usecase(
    ...
    return ForgotPasswordUseCase(user_repository=user_repository, redis=redis)
